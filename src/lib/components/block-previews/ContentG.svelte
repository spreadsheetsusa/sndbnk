<svg class="block-preview" viewBox="0 0 266 150" fill="none" aria-hidden="true">
	<path fill="var(--solid)" d="M0 0h266v150H0z"></path><path
		...
		fill="var(--base-500)"
	></path><rect x="59" y="104" width="40" height="10" rx="2" fill="var(--main-500)"></rect><path
	...
	></path><rect x="56" y="73" width="46" height="5" rx="2.5" fill="var(--solid-900)"></rect><path
		d="M150.692 86a2 2 0 012-2h70.707a2 2 0 010 4h-70.707a2 2 0 01-2-2z"
		fill="var(--base-500)"
	></path><rect x="168" y="104" width="40" height="10" rx="2" fill="var(--main-500)"></rect><path
	...
	></path><path
		...
		stroke-linecap="round"
		stroke-linejoin="round"
	></path><rect x="165" y="73" width="46" height="5" rx="2.5" fill="var(--solid-900)"></rect>
</svg>
