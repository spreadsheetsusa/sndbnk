<svg class="block-preview" viewBox="0 0 266 150" fill="none" aria-hidden="true">
	<path fill="var(--solid)" d="M0 0h266v150H0z"></path><rect
		...
		rx="2.5"
		fill="var(--solid-900)"
	></rect><rect x="20" y="112" width="26" height="5" rx="2.5" fill="var(--solid-900)"></rect><rect
		x="20"
		y="30"
		width="38"
		height="3"
		rx="1.5"
		fill="var(--base-400)"
	></rect><rect x="20" y="55" width="26" height="3" rx="1.5" fill="var(--main-500)"></rect><path
		d="M56 56.5a1.5 1.5 0 011.5-1.5h23a1.5 1.5 0 010 3h-23a1.5 1.5 0 01-1.5-1.5z"
		fill="var(--base-500)"
	></path><rect x="92" y="55" width="26" height="3" rx="1.5" fill="var(--base-500)"></rect><rect
		x="20"
		y="73"
		width="92"
		height="4"
	...
	></rect><path
		...
		fill="var(--base-300)"
	></path><rect x="87" y="110" width="31" height="10" rx="2" fill="var(--main-500)"></rect><rect
		x="20"
		y="81"
		width="82"
		height="4"
		rx="2"
		fill="var(--base-500)"
	></rect><rect x="20" y="89" width="68" height="4" rx="2" fill="var(--base-500)"></rect><path
		fill="var(--main-500)"
		d="M20 64h32v2H20z"
	></path><path
	...
	></path><circle cx="128" cy="114" r="5" fill="var(--base-300)"></circle>
</svg>
