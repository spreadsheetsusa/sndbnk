<svg class="block-preview" viewBox="0 0 266 150" fill="none" aria-hidden="true">
	...
	></path><path
		...
		fill="var(--main-500)"
	></path><rect x="108" y="45" width="50" height="4" rx="2" fill="var(--solid-900)"></rect><path
	...
	></path><path
		...
		fill="var(--main-500)"
	></path><rect x="89" y="94" width="26" height="4" rx="2" fill="var(--solid-900)"></rect><path
	...
	></path><path
		...
		fill="var(--main-500)"
	></path><rect x="154" y="94" width="26" height="4" rx="2" fill="var(--solid-900)"></rect>
</svg>
