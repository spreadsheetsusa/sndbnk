<svg class="block-preview" viewBox="0 0 266 150" fill="none" aria-hidden="true">
	...
	></path><path
		...
		fill="var(--solid-900)"
	></path><path d="M20 60a3 3 0 013-3h6a3 3 0 110 6h-6a3 3 0 01-3-3z" fill="var(--base-300)"
	></path><circle cx="44" cy="88" r="5" fill="var(--base-300)"></circle><path
	...
	></path><path
		...
		fill="var(--solid-900)"
	></path><path d="M99 60a3 3 0 013-3h6a3 3 0 110 6h-6a3 3 0 01-3-3z" fill="var(--base-300)"
	></path><circle cx="123" cy="88" r="5" fill="var(--base-300)"></circle><path
	...
	></path><path
		...
		fill="var(--solid-900)"
	></path><path d="M178 60a3 3 0 013-3h6a3 3 0 110 6h-6a3 3 0 01-3-3z" fill="var(--base-300)"
	></path><circle cx="202" cy="88" r="5" fill="var(--base-300)"></circle><path
