<svg class="block-preview" viewBox="0 0 266 150" fill="none" aria-hidden="true">
	<path fill="var(--solid)" d="M0 0h266v150H0z"></path><rect
		...
		rx="2"
		fill="var(--base-500)"
	></rect><rect x="20" y="32" width="74" height="5" rx="2.5" fill="var(--solid-900)"></rect><rect
		x="142"
		y="40"
		width="77"
		height="4"
		rx="2"
		fill="var(--base-500)"
	></rect><rect x="20" y="74" width="50" height="44" rx="2" fill="var(--base-200)"></rect><path
	...
	></path><rect x="24" y="108" width="28" height="2" rx="1" fill="var(--solid-900)"></rect><rect
		x="24"
		y="112"
		width="34"
		height="2"
		rx="1"
		fill="var(--base-500)"
	></rect><rect x="24" y="104" width="10" height="2" rx="1" fill="var(--main-500)"></rect><rect
		x="79"
		y="74"
		width="50"
		height="44"
	...
	></rect><path
		...
		stroke-linecap="round"
		stroke-linejoin="round"
	></path><rect x="83" y="108" width="28" height="2" rx="1" fill="var(--solid-900)"></rect><rect
		x="83"
		y="112"
		width="34"
		height="2"
		rx="1"
		fill="var(--base-500)"
	></rect><rect x="83" y="104" width="10" height="2" rx="1" fill="var(--main-500)"></rect><rect
		x="138"
		y="74"
		width="50"
		height="44"
	...
	></rect><path
		...
		stroke-linecap="round"
		stroke-linejoin="round"
	></path><rect x="142" y="108" width="28" height="2" rx="1" fill="var(--solid-900)"></rect><rect
		x="142"
		y="112"
		width="34"
		height="2"
		rx="1"
		fill="var(--base-500)"
	></rect><rect x="142" y="104" width="10" height="2" rx="1" fill="var(--main-500)"></rect><rect
		x="197"
		y="74"
		width="50"
		height="44"
	...
	></rect><path
		...
		stroke-linecap="round"
		stroke-linejoin="round"
	></path><rect x="201" y="108" width="28" height="2" rx="1" fill="var(--solid-900)"></rect><rect
		x="201"
		y="112"
		width="34"
		height="2"
		rx="1"
		fill="var(--base-500)"
	></rect><rect x="201" y="104" width="10" height="2" rx="1" fill="var(--main-500)"></rect>
</svg>
