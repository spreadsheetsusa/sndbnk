<svg class="block-preview" viewBox="0 0 266 150" fill="none" aria-hidden="true">
	<path fill="var(--solid)" d="M0 0h266v150H0z"></path><rect
		...
		rx="2.5"
		fill="var(--solid-900)"
	></rect><circle cx="26" cy="90" r="6" fill="var(--main-200)"></circle><rect
		x="82"
		y="48"
		width="102"
		height="5"
	...
	></path><path
		...
		fill="var(--main-500)"
	></path><rect x="38" y="84" width="43" height="4" rx="2" fill="var(--solid-900)"></rect><circle
		cx="105"
		cy="90"
		r="6"
		fill="var(--main-200)"
	...
	></path><path
		...
		fill="var(--main-500)"
	></path><rect x="117" y="84" width="43" height="4" rx="2" fill="var(--solid-900)"></rect><circle
		cx="184"
		cy="90"
		r="6"
		fill="var(--main-200)"
	...
	></path><path
		...
		fill="var(--main-500)"
	></path><rect x="196" y="84" width="43" height="4" rx="2" fill="var(--solid-900)"></rect>
</svg>
