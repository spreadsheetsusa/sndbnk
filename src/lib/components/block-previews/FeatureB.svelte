<svg class="block-preview" viewBox="0 0 266 150" fill="none" aria-hidden="true">
	...
	></path><path
		...
		fill="var(--main-500)"
	></path><rect x="25" y="77" width="58" height="4" rx="2" fill="var(--solid-900)"></rect><circle
		cx="135"
		cy="61"
		r="8"
		fill="var(--main-200)"
	...
	></path><path
		...
		fill="var(--main-500)"
	></path><rect x="104" y="77" width="58" height="4" rx="2" fill="var(--solid-900)"></rect><circle
		cx="214"
		cy="61"
		r="8"
		fill="var(--main-200)"
	...
	></path><path
		...
		fill="var(--main-500)"
	></path><rect x="183" y="77" width="58" height="4" rx="2" fill="var(--solid-900)"></rect><rect
		x="81"
		y="32"
		width="104.391"
		height="4"
		rx="2"
		fill="var(--base-500)"
	></rect><rect x="96" y="21" width="74" height="5" rx="2.5" fill="var(--solid-900)"></rect><rect
		x="113"
		y="120"
		width="40"
		height="10"
