<svg class="block-preview" viewBox="0 0 266 150" fill="none" aria-hidden="true">
	...
	></path><path
		...
		fill="var(--base-500)"
	></path><path d="M106 115a2 2 0 012-2h20a2 2 0 110 4h-20a2 2 0 01-2-2z" fill="var(--main-500)"
	></path><path d="M45 104a2 2 0 012-2h20a2 2 0 110 4H47a2 2 0 01-2-2z" fill="var(--solid-900)"
	></path><rect x="37" y="110" width="40" height="2" rx="1" fill="var(--base-500)"></rect><rect
		x="35"
		y="120"
		width="44"
		height="2"
		rx="1"
		fill="var(--base-500)"
	></rect><path d="M33 116a1 1 0 011-1h45a1 1 0 010 2H34a1 1 0 01-1-1z" fill="var(--base-500)"
	></path><path
	...
	></path><circle cx="56.5" cy="85.5" r="10.5" fill="var(--base-300)"></circle>
</svg>
