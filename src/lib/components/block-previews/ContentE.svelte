<svg class="block-preview" viewBox="0 0 266 150" fill="none" aria-hidden="true">
	<path fill="var(--solid)" d="M0 0h266v150H0z"></path><path
		...
		fill="var(--base-400)"
	></path><rect x="20" y="69" width="70" height="5" rx="2.5" fill="var(--solid-900)"></rect><rect
		x="20"
		y="78"
		width="92"
		height="5"
	...
	></rect><path
		...
		fill="var(--base-500)"
	></path><path d="M190 89a2 2 0 012-2h20a2 2 0 110 4h-20a2 2 0 01-2-2z" fill="var(--main-500)"
	></path><rect x="144" y="84" width="40" height="10" rx="2" fill="var(--main-500)"></rect>
</svg>
