<svg class="block-preview" viewBox="0 0 266 150" fill="none" aria-hidden="true">
	<path fill="var(--solid)" d="M0 0h266v150H0z"></path><rect
		...
		fill="var(--solid)"
		stroke="var(--base-400)"
	></rect><circle cx="32" cy="68" r="6" fill="var(--main-200)"></circle><path
	...
	></path><path
		...
		fill="var(--main-500)"
	></path><rect x="44" y="62" width="32" height="4" rx="2" fill="var(--solid-900)"></rect><rect
		x="138.5"
		y="54.5"
		width="107"
		height="41"
		...
		fill="var(--solid)"
		stroke="var(--base-400)"
	></rect><circle cx="150" cy="68" r="6" fill="var(--main-200)"></circle><path
	...
	></path><path
		...
		fill="var(--main-500)"
	></path><rect x="162" y="62" width="32" height="4" rx="2" fill="var(--solid-900)"></rect>
</svg>
