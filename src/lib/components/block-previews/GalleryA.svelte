<svg class="block-preview" viewBox="0 0 266 150" fill="none" aria-hidden="true">
	...
	></rect><rect x="20" y="32" width="74" height="5" rx="2.5" fill="var(--solid-900)"></rect><rect
		...
		rx="2"
		fill="var(--base-500)"
	></rect><path fill="var(--base-200)" d="M20 61h55v27H20zM20 91h111v39H20z"></path><path
	...
	></path><path fill="var(--base-200)" d="M78 61h53v27H78z"></path><path
		...
		stroke-linecap="round"
		stroke-linejoin="round"
	></path><path fill="var(--base-200)" d="M134 103h56v27h-56z"></path><path
		...
		stroke-linecap="round"
		stroke-linejoin="round"
	></path><path fill="var(--base-200)" d="M134 61h112v39H134zM193 103h53v27h-53z"></path><path
