...
| `/signin`, `/signup`               | redirects if signed in | email/password auth; signup requires Turnstile (when configured) + email confirmation before sign-in; success → `303 → /signin?pending=1` or `/` |
